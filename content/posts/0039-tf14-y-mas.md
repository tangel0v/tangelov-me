...
Tras los cambios sufridos en la versión 0.12 de Terrafor, Hashicorp ha continuado mejorando su herramienta y añadiendo nuevas funcionalidades sin parar. Las más importantes bajo mi punto de vista, son las siguientes:
...
* [Repositorio con el código de Infraestructura de Tangelov.me](https://gitlab.com/tangelov/tangelov-infra)

* [Guía de actualización a la versión 0.14 de terraform (ENG)](https://www.terraform.io/upgrade-guides/0-14.html)
...
* [Conectores a fuentes de datos soportados por Data Studio (ENG)](https://datastudio.google.com/data)
