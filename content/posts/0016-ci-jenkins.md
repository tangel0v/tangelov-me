...
Ahora debemos construir la imagen con el comando ```docker build -t jenkins/jenkins:lts .```

Una vez ya hemos construido nuestra imagen Docker, sólo necesitamos ejecutar este comando para tener un Jenkins totalmente funcional, independientemente del sistema operativo o de la distribución Linux que usemos:
...
En primer lugar vamos a crear una nueva credencial de Jenkins para que pueda acceder al contenido de Git a través de la API. Se hace en _Jenkins/Credentials/System/Add Credentials_

![credencial-gitlab](https://storage.googleapis.com/tangelov-data/images/0016-02.png)

Después configuramos la conexión contra Gitlab en _Configurar el Sistema_:

![jenkins-gitlab](https://storage.googleapis.com/tangelov-data/images/0016-03.png) 


Ahora vamos a crear una nueva tarea y vamos hacer click en _Crear un proyecto de estilo libre_ y hacemos click en OK.
...
Y en la pestaña de configurar el código fuente, seleccionamos la rama que queremos utilizar y la forma de conectarnos. Si usamos SSH tendremos que añadir una nueva credencial con nuestra llave.

![gitlab-credentials](https://storage.googleapis.com/tangelov-data/images/0016-05.png)

Y finalmente en ejecutar añadimos el tipo de paso _Ejecutar linea de comandos (shell)_ con el siguiente contenido:
